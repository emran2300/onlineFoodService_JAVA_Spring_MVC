                    ...
                    <div class="col-sm-6">
                        <div class="search-box">
                            <div class="input-group">
                                <input type="text" id="search" class="form-control" placeholder="Search by category">
                ...
                <c:forEach var="category" items="${leftCategories}">
                    ...
                    <c:forEach var="product" items="${category.products}">
                        ...
                        <tr>
                            ...
                            <td><a href="addToCart?productId=${product.productId}" class="add" title="Add" data-toggle="tooltip"><i class="material-icons">&#xE254;</i></a></td>
