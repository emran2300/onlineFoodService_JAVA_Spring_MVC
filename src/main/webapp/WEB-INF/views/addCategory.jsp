            ...
            <div class="col-lg-8 col-xl-6">
                <div class="card rounded-3">
                    ...
                    <div class="card-body p-4 p-md-5">
                        ...
                        <form:form class="px-md-2" modelAttribute="addCategory" action="addOnCategory" method="POST" >

                            <div class="form-outline mb-4">
                                <form:input path="categoryName" type="text" id="form3Example1q" class="form-control" />
